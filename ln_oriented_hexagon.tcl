...
proc linked_carb.oriented.hexagon {p6 size geom_center geom_center_att} {
	...
	set hexagon_size [expr $size*1]
        set half_length [expr $hexagon_size/2]
        set thickness [expr $hexagon_size/4]
...
# Draw the hexagon
	#Front-side
        ...
        draw triangle $front_1 $front_6 $center_1
	...
	# Back-side
        ...
        draw triangle $back_5 $back_6 $center_2
	...
	# Connect
        ...
        draw triangle $back_6 $front_5 $front_6
        draw triangle $back_6 $back_1 $front_6
        draw triangle $back_1 $front_6 $front_1
